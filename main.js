...
var w = c.width = window.innerWidth,
    h = c.height = isMobileDevice() ? window.innerHeight : window.innerHeight,
    ctx = c.getContext('2d'),

    hw = w / 2, // half-width
    hh = isMobileDevice() ? h / 1.5 : h / 1.15, // half-height for mobile or desktop

    opts = {
        strings: ['HAPPY', 'BIRTHDAY!', 'Annu Singh'],
        charSize: 30,
        charSpacing: 35,
        lineHeight: 40,
